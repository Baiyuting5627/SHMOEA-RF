...
% cite-50，problem- WFG and SMOP 

%------------------------------- Reference --------------------------------
% Y. Tian, R. Wang, Y. Zhang, and X. Zhang. 
...
%--------------------------------------------------------------------------
    ...
    methods
        function main(Algorithm,Problem)  
            ...
            %Population1 = Multiple_Sampling(Problem,Population1,num_sample);         
            Population2  = Problem.Initialization();   
            %Population2 = Multiple_Sampling(Problem,Population2,num_sample);         
            ...
            while Algorithm.NotTerminated(Population1)
                ...
                if FR <= alpha || gen <= last_gen
                    ...
                    %Offspring1 = Multiple_Sampling(Problem,Offspring1,num_sample);    
                    Offspring2  = OperatorGA(Problem,Population2(MatingPool2));
                    %Offspring2 = Multiple_Sampling(Problem,Offspring2,num_sample);   
                ...
                % if flag == 0 && Problem.FE >= Problem.maxFE - num_sample*length(Population1)
                %    Population1 = Multiple_Sampling(Problem, Population1, num_sample);                                     
                %    flag = 1;
                % end
                gen = gen+1;
