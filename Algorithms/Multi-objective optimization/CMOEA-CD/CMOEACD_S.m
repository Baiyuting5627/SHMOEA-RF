        ...
        function main(Algorithm,Problem)
            ...
            while Algorithm.NotTerminated(FEA)
                ...
                if rand() < 0.5
                    ...
                    %Offspring3 = Multiple_Sampling(Problem,Offspring3,num_sample);   
                else
                ...
                % if flag == 0 && Problem.FE >= Problem.maxFE - num_sample*length(Offspring)
                %    Offspring= Multiple_Sampling(Problem, Offspring, num_sample);                                     
                %    flag = 1;
                % end
            end
        end
