...
%--------------------------------------------------------------------------
    ...
    methods
        function main(Algorithm,Problem)         
            ...
            [Population] = Greedy_Repair_Nonscalar(Problem,Population);            % 贪婪修正
            [Population] = Multiple_Sampling(Problem,Population,num_Samples);      % 多次评估  
