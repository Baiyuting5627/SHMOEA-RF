...
%--------------------------------------------------------------------------
    ...
    methods
       ...
       function R = GetOptimum(obj,~)
           %data=load('D:\白雨婷\PlatEMO-master-bai\PlatEMO\Real_PF\PF_2_750_5.mat');% 2-250
           data=load('D:\白雨婷\PlatEMO_latest\PlatEMO-master\PlatEMO\Real_PF\Re_PF_2_750_5.mat');
           R=data.PS.objs;         
