classdef EU_MOKP_2_500< PROBLEM
...
%--------------------------------------------------------------------------
    ...
    methods
        ...
        function Setting(obj)   % obj: PROBLEM class
            ...
            file = sprintf('MOKP-M%d-D%d_10.mat',obj.M,obj.D);
        ...
        function PopObj = CalObj(obj,PopDec)                           
             ...
             ratio_randprofit = 0.1;                                       % 对应Item的Profit随机扰动比例（前10%的变量进行扰动）
             P_bak = obj.P;                                                % 原始价值向量
       ...
       function R = GetOptimum(obj,~)
           %data=load('D:\白雨婷\PlatEMO-master-bai\PlatEMO\Real_PF\U_PF_2_2.mat');% 2-250
           data=load('D:\白雨婷\PlatEMO_latest\PlatEMO-master\PlatEMO\Real_PF\Re_U_PF_2_2.mat');% 2-250
           %R=data.PS;          % 二次前沿
           R=data.PS.objs;    % 普通前沿
