...
%--------------------------------------------------------------------------
    ...
    methods
       ...
       function R = GetOptimum(obj,~)
           %data=load('D:\白雨婷\PlatEMO-master-bai\PlatEMO\Real_PF\PF_2_500_5.mat');%
           
           data=load('D:\白雨婷\PlatEMO_latest\PlatEMO-master\PlatEMO\Real_PF\Re_PF_2_500_5.mat');
           %R=data.PS;          %二次前沿
           R=data.PS.objs;    %普通前沿
