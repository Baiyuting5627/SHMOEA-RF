classdef EU_MOKP_2_250_5 < PROBLEM
...
%--------------------------------------------------------------------------
    ...
    methods
        ...
        function PopObj = CalObj(obj,PopDec)                           
             ...
             PopObj = repmat(obj.N*obj.D, size(PopDec, 1), 2)-log_value;     %100*2 将目标值从最大值基准中扣除，转化为一个极小化问题PopObj = repmat(100*obj.D, size(PopDec, 1), 2)-total_value;     %100*2 将目标值从最大值基准中扣除，转化为一个极小化问题
        end
       ...
       function R = GetOptimum(obj,~)
           data=load('D:\白雨婷\PlatEMO_latest\PlatEMO-master\PlatEMO\Real_PF\Re_U_PF_1_1.mat');% 2-250
           R=data.PS.objs;          
