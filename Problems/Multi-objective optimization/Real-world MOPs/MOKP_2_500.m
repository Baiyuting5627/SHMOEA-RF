...
%--------------------------------------------------------------------------
    ...
    methods
        ...
        function PopObj = CalObj(obj,PopDec)                           
             ...
             PopObj = repmat(obj.N*obj.D, size(PopDec, 1), 2)-total_value;     %100*2 将目标值从最大值基准中扣除，转化为一个极小化问题
        end
       ...
       function R = GetOptimum(obj,~)
           %data=load('D:\白雨婷\PlatEMO-master-bai\PlatEMO\Real_PF\PF_2_500_10.mat');% 2-250
           data=load('D:\白雨婷\PlatEMO_latest\PlatEMO-master\PlatEMO\Real_PF\Re_PF_2_500_10.mat');
           %R=data.PS;          % 二次前沿
           R=data.PS.objs;    % 普通前沿
